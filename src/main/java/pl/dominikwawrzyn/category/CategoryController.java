...
public class CategoryController {
    ...
    @Autowired
    public CategoryController(CategoryRepository categoryRepository, ProductsBarRepository productsBarRepository, ProductsKitchenRepository productsKitchenRepository) {
...
//        List<List<ProductsBar>> listOfProductsBarList = new ArrayList<>();
//        for (Category category : categories) {
//            List<ProductsBar> productsBarList = productsBarRepository.findByCategory(category);
//            listOfProductsBarList.add(productsBarList);
//        }
//        model.addAttribute("categories", categories);
//        model.addAttribute("listOfProductsBarList", listOfProductsBarList);
